...
angular.module('myABS').factory('absFactory',[
    'absObject',
    function(absObject) {
        ...
        return function absFactory(model, sameByData, sameByInstance){
             ...
             * @param   {string|object}   args        instance id, data set including an instance id or data set without an id
             * @return  {instance}                    returns a new model instance populated with the provided data
             */
